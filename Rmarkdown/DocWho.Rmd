...
suppressWarnings(treemap(head(char_vals,50), index="cat", vSize="pct", title = "Who has the most lines?", palette = brewer.pal(n=16, "Set3")))
```
</div>
<div style="width: 50%; float: left;">
...
suppressWarnings(treemap(head(char_vals2,50), index="cat", vSize="pct", title="... Other than the doctor?", palette = brewer.pal(n=16, "Set3")))
```
</div>
